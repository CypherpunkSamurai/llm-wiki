...
3. **External search** — equal priority when quota allows. Semantic search, web depth, natural language queries. Use comprehensive research when ~10 searches insufficient. Paginate for multi-page results.
4. **GitHub** — codebase search with language filter, sort by recently updated
5. **arXiv / alphaxiv** — academic papers and preprints
6. **Fetch** — read URL content after search finds it
