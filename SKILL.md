...
3. **Exa / Tavily / Linkup** — equal priority when quota allows, paginate for multi-page. Exa = semantic, Tavily = web depth (`tavily_research` when ~10 searches insufficient), Linkup = natural language
